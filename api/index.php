		...
		if(mysqli_num_rows($sqlPoison) > 0)
		{
			...
			else
			{
				...
				if($db)
				{
					...
					$message    = 'You have been invited to join '.$groupName.' Umubare uranga gurupe: '.$groupId.' (a contribution group on UPlus). for more info, click here. https://xms9d.app.goo.gl/PeSx or *801*2#';
